                  ...
                  <Stack spacing="sm">
                    ...
                    <div className="space-y-2 pt-2">
                      <button
                        ...
                        className="w-full px-4 py-2 rounded-md border border-background-border dark:border-dark-background-border text-text-secondary dark:text-dark-text-secondary hover:bg-background-surface dark:hover:bg-dark-background-surface transition-colors text-left"
                      >
                        Add New Book
                      </button>
                      <button
